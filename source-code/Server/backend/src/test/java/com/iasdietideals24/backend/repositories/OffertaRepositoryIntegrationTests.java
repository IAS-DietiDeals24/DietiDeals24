...
class OffertaRepositoryIntegrationTests {
    ...
    void testMultipleOffertaCanBeCreatedAndRecalled() throws InvalidTypeException {
        ...
        Profilo profiloVenditoreCollegatoC = TestDataProfilo.createProfiloVenditoreB();
        Venditore venditoreCollegatoC = profiloVenditoreCollegatoC.getVenditore();
        OffertaDiVenditore offertaC = TestDataOffertaInversa.createOffertaInversaA(venditoreCollegatoC, astaRiferimentoC);
