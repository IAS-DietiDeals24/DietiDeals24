...
public class TestDataNotifica {
    ...
    public static Notifica createNotificaA(final Account mittente, final Set<Account> destinatari, final Asta astaAssociata) {
    ...
    public static Notifica createNotificaB(final Account mittente, final Set<Account> destinatari, final Asta astaAssociata) {
    ...
    public static Notifica createNotificaC(final Account mittente, final Set<Account> destinatari, final Asta astaAssociata) {
