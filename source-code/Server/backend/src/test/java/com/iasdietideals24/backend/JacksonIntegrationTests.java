...
class JacksonIntegrationTests {
    ...
    void testObjectMapperCreateJsonObjectFromJavaObject() throws JsonProcessingException, InvalidTypeException {
        ...
        // Act
        String oracolo = "{\"idAsta\":null,\"nome\":\"Dragon Age: Origins Xbox 360\",\"descrizione\":\"Edizione Xbox 360 del videogioco Dragon Age: Origins. Ci giocava mio marito.\",\"dataScadenza\":[2024,6,19],\"oraScadenza\":[18,44],\"immagine\":null,\"categoriaShallow\":{\"nome\":\"VIDEOGAMES_AND_CONSOLES\"},\"notificheAssociateShallow\":[],\"proprietarioShallow\":{\"idAccount\":null,\"tipoAccount\":\"Compratore\"},\"sogliaIniziale\":1.0,\"offerteRicevuteShallow\":[]}";
    ...
    void testObjectMapperCreateJavaObjectFromJsonObject() throws JsonProcessingException, InvalidTypeException {
        // Arrange
        String json = "{\"idAsta\":null,\"nome\":\"Dragon Age: Origins Xbox 360\",\"descrizione\":\"Edizione Xbox 360 del videogioco Dragon Age: Origins. Ci giocava mio marito.\",\"dataScadenza\":[2024,6,19],\"oraScadenza\":[18,44],\"immagine\":null,\"categoriaShallow\":{\"nome\":\"VIDEOGAMES_AND_CONSOLES\"},\"notificheAssociateShallow\":[],\"proprietarioShallow\":{\"idAccount\":null,\"tipoAccount\":\"Compratore\"},\"sogliaIniziale\":1.0,\"offerteRicevuteShallow\":[]}";
