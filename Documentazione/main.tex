...
\newpage
    ...
    \include{Codice/Documento dei Requisiti Software/Glossario}
    \include{Codice/Documento dei Requisiti Software/RequirementElicitation}
    \include{Codice/Documento dei Requisiti Software/RequirementAnalysis}
    \include{Codice/Documento dei Requisiti Software/RequirementSpecification}
    \include{Codice/Documento di Design del sistema/SystemDesign}
    \include{Codice/Documento di Design del sistema/ObjectDesign}
    \include{Codice/Testing e valutazione sul campo/VerificaSoftware}
    \include{Codice/Testing e valutazione sul campo/ValidazioneSoftware}
    
    L'intero progetto è stato sviluppato con l'ausilio di uno strumento di versioning: GitHub. \\
    La repository è consultabile \href{https://github.com/IAS-DietiDeals24/DietiDeals24}{\underline{qui}}.
