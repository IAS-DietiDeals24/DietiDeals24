\chapter{Object Design}
    ...
    \section{Sequence Diagram di design}
        \begin{figure}[htbp!]
            \centering
                \includegraphics[width=0.1\linewidth]{Immagini/WorkInProgress.pdf}
            \caption{Sequence Diagram di design creazione asta inversa}
            \label{fig:Sequence Diagram di design creazione asta inversa}
        \end{figure}

        \begin{figure}[htbp!]
            \centering
                \includegraphics[width=0.1\linewidth]{Immagini/WorkInProgress.pdf}
            \caption{Sequence Diagram di design accetta offerta per un'asta silenziosa}
            \label{fig:Sequence Diagram di design accetta offerta per un'asta silenziosa}
        \end{figure}

        \begin{figure}[htbp!]
            \centering
                \includegraphics[width=0.1\linewidth]{Immagini/WorkInProgress.pdf}
            \caption{Sequence Diagram di design visualizza dettagli asta}
            \label{fig:Sequence Diagram di design visualizza dettagli asta}
        \end{figure}

        \begin{figure}[htbp!]
            \centering
                \includegraphics[width=0.1\linewidth]{Immagini/WorkInProgress.pdf}
            \caption{Sequence Diagram di design modifica dati profilo}
            \label{fig:Sequence Diagram di design modifica dati profilo}
        \end{figure}